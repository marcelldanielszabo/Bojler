...
<body>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">Bojler</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/auth_restaurants">Regisztráció</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/auth_settings">Bejelentkezés</a>
          </li>
        </ul>
      </div>
    </div>
...
<!-- Navbar -->
        ...
        <div class="px-4 pt-5 my-5 text-center border-bottom">
            <h1 class="display-4 fw-bold"> Bojler</h1>
            <div class="col-lg-6 mx-auto">
            <p class="lead mb-4"><i> Lorem ipsum dolor sit amet</i></p>
            ...
            <div class="col-sm-4">
              <div class="card">
                <div class="card-body">
                  ...
                  <a href="#" class="btn btn-primary btn-lg btn-block">Ipsum</a>
                </div>
              </div>
            </div>
          </div>
